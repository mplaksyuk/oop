...
public class TokenManager {
    ...
    private static final long ACCESS_LIFE  = 60L * 1000L; // 1 min
    ...
    private static String generateToken(Integer id, Models.enums.Role role, Key secret, long life_time) {
    ...
    public static String generateAccessToken(Integer id, Models.enums.Role role) {
        return generateToken(id, role, ACCESS_SECRET, ACCESS_LIFE);
    }

    public static String generateRefreshToken(Integer id, Models.enums.Role role) {
