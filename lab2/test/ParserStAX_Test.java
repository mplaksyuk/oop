...
public class ParserStAX_Test {
    ...
    @Test
    public void BeerAttrTest() throws FileNotFoundException, XMLStreamException{
        ParserStAX ParserStAX = new ParserStAX();
        List<Beer> beerMarket = ParserStAX.parse(src);
    ...
    @Test
    public void BeerIngredientsTest() throws FileNotFoundException, XMLStreamException{
        ParserStAX ParserStAX = new ParserStAX();
        ArrayList<Beer> beerMarket = ParserStAX.parse(src);
    ...
    @Test
    public void BeerCharsTest() throws FileNotFoundException, XMLStreamException{
        ParserStAX ParserStAX = new ParserStAX();
        ArrayList<Beer> beerMarket = ParserStAX.parse(src);
    ...
    @Test
    public void BeerBottleTest() throws FileNotFoundException, XMLStreamException{
        ParserStAX ParserStAX = new ParserStAX();
        ArrayList<Beer> beerMarket = ParserStAX.parse(src);
